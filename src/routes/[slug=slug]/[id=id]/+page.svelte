...
<section id="content" class="flex flex-col gap-8 px-5 h-full overflow-y-auto pb-[110px]">
  {#if content}
    ...
    <div dir="rtl" class="text-5xl text-green-900 leading-relaxed tracking-wide">{content.arabic}</div>
    <p class="italic font-semibold text-xl text-gray-900">{content.latin.toLowerCase()}</p>
